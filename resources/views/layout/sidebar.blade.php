 <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
     <div class="position-sticky pt-3">
         <ul class="nav flex-column">
             ...
             <li class="nav-item">
                 <a class="nav-link {{ request()->is('products*') ? 'active' : '' }}" href="{{route('product.index')}}">
             ...
             <li class="nav-item">
                 <a class="nav-link  {{ request()->is('coupons*') ? 'active' : '' }}" href="{{ route('coupon.index') }}">
                     <i class="bi bi-percent me-2"></i>
                     تخفیف ها
                 </a>
             </li>
             <li class="nav-item ">
                 <a class="nav-link {{ request()->is('contact-us*') ? 'active' : '' }} " href="{{ route('contact.index') }}">
                     <i class="bi  bi-chat-left-text me-2"></i>
                      نماس با ما
                 </a>
             </li>
             <li class="nav-item dropdown-center">
                 <a class="nav-link dropdown-toggle {{ request()->is('slider*') ? 'active' : '' }}{{ request()->is('feature*') ? 'active' : '' }}
                    {{ request()->is('about-us*') ? 'active' : '' }} {{ request()->is('footer*') ? 'active' : '' }}"
